...
export const EventProgressCard = ({
  ...
  return (
    <div className="w-[30%] flex flex-col rounded-xl bg-white m-3 justify-around relative">
      <div className="flex h-[30%] justify-around pt-4 pb-2 px-2">
        <div className="flex border justify-around items-center px-1">
          <img src={CalendarIcon} style={{ width: "2vh", height: "2vh" }} />
          <div className="text-md text-black">
            {date?.toString().substring(0, 10)}
          </div>
        </div>
        <div className="flex px-2 border justify-around items-center">
