      ...
      <div className="flex flex-col items-center justify-center w-[100vw] bg-gray-100 pt-[10vh]  md:mt-0">
          ...
          <div className="flex flex-col md:flex-row px-8 relative ">
            ...
            <div className="text-black pt-4 xl:pt-0 text-4xl md:text-6xl font-bold flex flex-col justify-center items-center text-center md:w-[50%]">
              ...
              <div className="text-black text-lg md:text-xl pt-5 w-[100%] md:w-[80%] font-light md:font-semibold">
                <span>
                  Creating tailor-made digital solutions to connect high schools
                  to charities with increased convenience and accessibility,
        ...
        <div className="flex flex-col w-[100vw] md:h-[90vh] bg-gray-100 justify-center items-center text-center pb-10">
          ...
          <div className="flex flex-col text-black text-lg md:text-2xl pt-10 w-[100%] md:w-[60%] px-6 xs:font-light md:font-semibold ">
            <span>
              Our team brings a wealth of experience from participating in
              community service during our high school years, including members
              who have founded initiatives involving 60+ participants.
            </span>
          </div>
          ...
          <div className="flex flex-col md:flex-row w-[100%] bg-gray-100 pt-5 justify-center items-center md:px-6">
            <div className="flex flex-col w-[80%] h-[30vh]  bg-gray-200 rounded-2xl m-5 p-5 items-center justify-center">
              <span className="text-center font-semibold md:text-xl">
                “Finding and monitoring servic opportunities is a manual and
                time consuming process both for high school students and their
                administrators.
              </span>
            </div>
            <div className="flex flex-col w-[80%] h-[30vh] bg-gray-200 rounded-2xl m-5 p-5 items-center justify-center">
              <span className="text-center font-semibold md:text-xl">
                Charities struggle to find a consistent source of young and
                dynamic volunteers for their missions, hampering their planning
                and operational capabilities.
              </span>
            </div>
            <div className="flex flex-col w-[80%]   h-[30vh] bg-gray-200 rounded-2xl m-5 p-5 items-center justify-center">
              <span className="text-center font-semibold md:text-xl">
                A central challenge is the absence of a centralized platform
                with the necessary digital framework to enable dynamic
                interaction within these ecosystems.
              </span>
            </div>
          </div>
        </div>
        <div className="flex flex-col w-[100vw] bg-gray-100 justify-center items-center text-center pb-10">
          <div className="flex flex-col md:flex md:flex-row">
            <div className="text-4xl md:text-6xl text-black font-bold flex flex-col justify-center items-center text-center md:w-[50%]">
              ...
              <span>is a pathway across that void</span>
              <div className="flex flex-col text-black text-lg md:text-xl pt-10 w-[100%] md:w-[80%] px-6 xs:font-light md:font-semibold pb-5">
                <span>
                  ...
                  our mission. We are a vibrant platform that bridges the gap
                  between high school students eager to make a difference,
                  educational institutions seeking streamlined service programs,
                  and charities in need of enthusiastic volunteers. Our digital
                  hub is designed to empower students, support schools, and
                  bolster charitable efforts, creating a cohesive community
          ...
          <div className="flex flex-col md:flex-row w-[100%] bg-gray-100 pt-5 px-4 justify-center items-center md:px-6">
            ...
            <div className="flex flex-col w-[100%] bg-gray-200 rounded-2xl m-5 p-5 items-center justify-center h-[50vh] xl:h-[60vh] 2xl:h-[50vh]">
              ...
              <span className="text-center font-semibold md:text-xl">
                ...
                to take action. <br></br>Bridgy simplifies the
                volunteer-matching process, connecting your charity with
                students who share your passion for change.
              </span>
            </div>
            <div className="flex flex-col w-[100%]  bg-gray-200 rounded-2xl m-5 p-5 items-center justify-center h-[50vh] xl:h-[60vh] 2xl:h-[50vh]">
              <div className="flex flex-col items-center">
              ...
              <span className="text-center font-semibold md:text-xl">
                ...
                <br></br> With our hub, you can connect with meaningful projects
                in a snap, track your accomplishments, and build real-time
