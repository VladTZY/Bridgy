        ...
        <div className="flex flex-col w-[100vw]  md:h-[100vh] 2xl:h-[80vh] bg-gray-100 justify-center items-center">
          <div className="flex flex-col md:flex-row px-8 relative ">
            ...
            <div className="text-black pt-4 xl:pt-0 text-4xl md:text-6xl font-bold flex flex-col justify-center items-center text-center md:w-[50%]">
              ...
              <a
                href="login"
                class="mt-4 text-white bg-[#2EA0FB] hover:bg-[#2135D9] focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-xl px-10 py-3 focus:outline-none dark:focus:ring-blue-800 transform hover:scale-[105%] duration-300"
              >
                Login
              </a>
            </div>
